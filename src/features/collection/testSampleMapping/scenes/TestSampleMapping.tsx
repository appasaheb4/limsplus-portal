                    ...
                    <Controller
                      ...
                      render={({ field: { onChange } }) => (
                        <LibraryComponents.Atoms.Form.Input
                          ...
                          type="number"
                          value={testSampleMappingStore.departments?.prefrence ||''}
                          onChange={(prefrence) => {
                            onChange(prefrence)
                            testSampleMappingStore.updateDepartments({
                              ...testSampleMappingStore.departments,
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange } }) => (
                        <LibraryComponents.Atoms.Form.Input
                          ...
                          type="number"
                          value={testSampleMappingStore.departments?.tatInMin ||''}
                          onChange={(tatInMin) => {
                            onChange(tatInMin)
                            testSampleMappingStore.updateDepartments({
                              ...testSampleMappingStore.departments,
                    ...
                    <div className="mt-1 flex flex-row justify-between">
                      <LibraryComponents.Atoms.Buttons.Button
                        ...
                        onClick={() => {
                          ...
                          let departments =
                            testSampleMappingStore.testSampleMapping?.departments ||
                            []
                          if (
                            code === undefined ||
                            prefrence === undefined ||
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <LibraryComponents.Atoms.Form.Input
                      ...
                      value={
                        testSampleMappingStore.testSampleMapping?.repentionPeriod
                      }
