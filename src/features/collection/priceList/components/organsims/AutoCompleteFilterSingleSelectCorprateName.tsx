...
interface AutoCompleteFilterSingleSelectCorporateNameProps {
  onSelect: (item: any) => void
}

export const AutoCompleteFilterSingleSelectCorporateName = observer(
  ({ onSelect }: AutoCompleteFilterSingleSelectCorporateNameProps) => {
