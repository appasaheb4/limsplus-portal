                  ...
                  <div className="mt-2">
                    <LibraryComponents.Atoms.Buttons.Button
                      ...
                      onClick={() => {
                        ...
                        if (state !== undefined) {
                          let arrState =
                            props.extraData.administrativeDiv && row.state
                          ...
                          props.onUpdateItem &&
                            props.onUpdateItem(arrState, "state", row._id)
                          props.extraData.updateLocalState({
                            ...props.extraData.localState,
                            state: "",
                          })
                    ...
                    {row.state?.map((item, index) => (
                      <div className="mb-2" key={index}>
                        <LibraryComponents.Atoms.Buttons.Button
                          ...
                          onClick={() => {
                            const firstArr = row.state?.slice(0, index) || []
                            const secondArr = row.state?.slice(index + 1) || []
                            ...
                            props.onUpdateItem &&
                              props.onUpdateItem(finalArray, "state", row._id)
                          }}
                        >
                          {item}
                        </LibraryComponents.Atoms.Buttons.Button>
                    ...
                    <LibraryComponents.Atoms.Buttons.Button
                      ...
                      onClick={() => {
                        ...
                        if (district === undefined)
                          return alert("Please Enter District")
                        if (district !== undefined) {
                          let arrState = row.district || []
                          props.onUpdateItem &&
                            props.onUpdateItem(arrState, "district", row._id)
                    ...
                    {row.district?.map((item, index) => (
                      <div className="mb-2" key={index}>
                        <LibraryComponents.Atoms.Buttons.Button
                          ...
                          icon={LibraryComponents.Atoms.Icon.Remove}
                          onClick={() => {
                            const firstArr = row.district?.slice(0, index) || []
                            const secondArr = row.district?.slice(index + 1) || []
                            const finalArray = [...firstArr, ...secondArr]
                            props.extraData.updateAdministrativeDiv({
                              ...props.extraData.administrativeDiv,
                              district: finalArray,
                            ...
                            props.onUpdateItem &&
                              props.onUpdateItem(finalArray, "district", row._id)
                          }}
                        >
                          {item}
                        </LibraryComponents.Atoms.Buttons.Button>
                  ...
                  <div className="mt-2">
                    <LibraryComponents.Atoms.Buttons.Button
                      ...
                      onClick={() => {
                        ...
                        if (city !== undefined) {
                          let arrState =
                            props.extraData.administrativeDiv && row.city
                          props.onUpdateItem &&
                            props.onUpdateItem(arrState, "city", row._id)
                          //  Stores.administrativeDivStore.updateAdministrativeDiv({
                          //    ...Stores.administrativeDivStore.administrativeDiv,
                          //    state: arrState? arrState.concat(state): [state]
                          //  })
                    ...
                    {row.city?.map((item, index) => (
                      <div className="mb-2" key={index}>
                        <LibraryComponents.Atoms.Buttons.Button
                          ...
                          icon={LibraryComponents.Atoms.Icon.Remove}
                          onClick={() => {
                            const firstArr = row.city?.slice(0, index) || []
                            const secondArr = row.city?.slice(index + 1) || []
                            const finalArray = [...firstArr, ...secondArr]
                            props.extraData.updateAdministrativeDiv({
                              ...props.extraData.administrativeDiv,
                              city: finalArray,
                            ...
                            props.onUpdateItem &&
                              props.onUpdateItem(finalArray, "city", row._id)
                          }}
                        >
                          {item}
                        </LibraryComponents.Atoms.Buttons.Button>
                  ...
                  <div className="mt-2">
                    <LibraryComponents.Atoms.Buttons.Button
                      ...
                      onClick={() => {
                        ...
                        if (area !== undefined) {
                          let arrState =
                            props.extraData.administrativeDiv && row.area
                          props.onUpdateItem &&
                            props.onUpdateItem(arrState, "area", row._id)
                          //  Stores.administrativeDivStore.updateAdministrativeDiv({
                          //    ...Stores.administrativeDivStore.administrativeDiv,
                          //    state: arrState? arrState.concat(state): [state]
                          //  })
                    ...
                    {row.area?.map((item, index) => (
                      <div className="mb-2" key={index}>
                        <LibraryComponents.Atoms.Buttons.Button
                          ...
                          icon={LibraryComponents.Atoms.Icon.Remove}
                          onClick={() => {
                            const firstArr = row.area?.slice(0, index) || []
                            const secondArr = row.area?.slice(index + 1) || []
                            const finalArray = [...firstArr, ...secondArr]
                            props.extraData.updateAdministrativeDiv({
                              ...props.extraData.administrativeDiv,
                              area: finalArray,
                            ...
                            props.onUpdateItem &&
                              props.onUpdateItem(finalArray, "area", row._id)
                          }}
                        >
                          {item}
                        </LibraryComponents.Atoms.Buttons.Button>
                  ...
                  <div className="mt-2">
                    <LibraryComponents.Atoms.Buttons.Button
                      ...
                      onClick={() => {
                        ...
                        if (postalCode !== undefined) {
                          let arrState =
                            props.extraData.administrativeDiv && row.postalCode
                          props.onUpdateItem &&
                            props.onUpdateItem(arrState, "postalCode", row._id)
                          //  Stores.administrativeDivStore.updateAdministrativeDiv({
                          //    ...Stores.administrativeDivStore.administrativeDiv,
                          //    state: arrState? arrState.concat(state): [state]
                          //  })
                    ...
                    {row.postalCode?.map((item, index) => (
                      <div className="mb-2" key={index}>
                        <LibraryComponents.Atoms.Buttons.Button
                          ...
                          icon={LibraryComponents.Atoms.Icon.Remove}
                          onClick={() => {
                            const firstArr = row.postalCode?.slice(0, index) || []
                            const secondArr = row.postalCode?.slice(index + 1) || []
                            const finalArray = [...firstArr, ...secondArr]
                            props.extraData.updateAdministrativeDiv({
                              ...props.extraData.administrativeDiv,
                            ...
                            props.onUpdateItem &&
                              props.onUpdateItem(finalArray, "postalCode", row._id)
                          }}
                        >
                          {item}
                        </LibraryComponents.Atoms.Buttons.Button>
