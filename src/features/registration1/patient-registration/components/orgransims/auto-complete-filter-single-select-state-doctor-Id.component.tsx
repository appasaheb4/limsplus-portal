...
interface AutoCompleteFilterSingleSelectDoctorIdProps {
  onSelect: (item: any) => void;
}

export const AutoCompleteFilterSingleSelectDoctorId = observer(
  ({onSelect}: AutoCompleteFilterSingleSelectDoctorIdProps) => {
