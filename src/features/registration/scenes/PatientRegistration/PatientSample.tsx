...
const PatientSample = observer((props:PatientSampleProps)=>{
    ...
    return(
        <>
            <div className='p-2 rounded-lg shadow-xl'>
                <LibraryComponents.Atoms.Grid cols={2}>
                    ...
                    <Controller
                        ...
                        label="Specimen ID"
                        name="txtSpecimenId"
                        placeholder={errors.specimenId?"Please Enter Specimen Id":"Specimen Id"}
              ...
              <Controller
                ...
                render={({ field: { onChange } }) => (
                  ...
                  >
                    ...
                    >
                      <option selected>Select</option>
                      {SampleTypeStore.sampleTypeStore.listSampleType&&SampleTypeStore.sampleTypeStore.listSampleType.map(
                        (item: any, index: number) => (
                          <option key={index} value={item.sampleType}>
            ...
            <LibraryComponents.Atoms.Form.InputDate
              ...
              placeholder={errors.receivedDate?"Please Enter ReceivedDate":"Received Date"}
            ...
            />
             <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
            <LibraryComponents.Atoms.Form.InputWrapper label="Method Collection" hasError={errors.methodCollection}>
              <select
                className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
           ...
           <Controller
            ...
            <LibraryComponents.Atoms.Form.InputDate
              ...
              placeholder={errors.dateCollection?"Please Enter Date Collection":"Date Collection"}
              ...
              <LibraryComponents.Atoms.Form.InputWrapper label="Environment">
                ...
                >
                  <option selected>
                        ...
                        stores.loginStore.login.role !== "SYSADMIN"
                          ? `Select`
                          : Stores.patientRegistationStore.patientSample?.environment || `Select`}
                      </option>
                  {LibraryUtils.lookupItems(stores.routerStore.lookupItems, "PATIENT SAMPLE - ENVIRONMENT").map(
                    (item: any, index: number) => (
                      <option key={index} value={item.code}>
                        {`${item.value} - ${item.code}`}
                      </option>
          ...
          />
            ...
            >
                <FeatureComponents.Molecules.PatientSampleList
