...
import {Buttons, List, Grid, Svg, Form} from '@/library/components';
    ...
    <>
      <div className='p-2 rounded-lg shadow-xl'>
        <Grid cols={2}>
              ...
              render={({field: {onChange}}) => (
                <Form.InputDate
                  ...
                  onChange={e => {
                    ...
                    onChange(infoDate);
                    const formatDate =
                      dayjs(infoDate).format('YYYY-MM-DD HH:mm');
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.Input
                  ...
                  name='txtKeyField'
                  placeholder={
                    errors.keyField ? 'Please Enter Key Field ' : 'KeyField'
                  }
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.InputWrapper
                  ...
                  hasError={errors.infoType}
                >
                  <select
                    className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
                      errors.infoType ? 'border-red-500  ' : 'border-gray-300'
                    } rounded-md`}
                    onChange={e => {
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.Input
                  ...
                  value={
                    Stores.patientRegistationStore.informationGroup?.information
                  }
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.Toggle
                  ...
                  value={
                    Stores.patientRegistationStore.informationGroup?.infoLookup
                  }
                  onChange={infoLookup => {
                    onChange(infoLookup);
                    Stores.patientRegistationStore.updateInformationGroup({
          ...
          <List direction='col' fill justify='stretch' space={4}>
            <Controller
              control={control}
              render={({field: {onChange}}) => (
                <Form.InputFile
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.InputWrapper label='Status'>
                  <select
                    value={
                      Stores.patientRegistationStore.informationGroup?.status
                    }
                    className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
