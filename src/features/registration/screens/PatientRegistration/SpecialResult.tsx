            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.InputWrapper label='Result Type'>
                  <select
                    value={
                      Stores.patientRegistationStore.specialResult?.resultType
                    }
                    className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
              ...
              render={({field: {onChange}}) => (
                ...
                >
                  <select
                    name='optionPatientResult'
                    className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
                      errors.lineNo ? 'border-red-500  ' : 'border-gray-300'
                    } rounded-md`}
                    onChange={e => {
              ...
              render={({field: {onChange}}) => (
                ...
                >
                  <select
                    name='optionPatientResult'
                    className={`leading-4 p-2 focus:outline-none focus:ring block w-full shadow-sm sm:text-base border-2 ${
                      errors.resultTest ? 'border-red-500  ' : 'border-gray-300'
                    } rounded-md`}
                    onChange={e => {
            ...
            <Controller
              ...
              render={({field: {onChange}}) => (
                <Form.InputWrapper label='Environment'>
                  <select
                    value={
                      Stores.patientRegistationStore.specialResult?.environment
                    }
                    disabled={
                      stores.loginStore.login &&
                      stores.loginStore.login.role !== 'SYSADMIN'
