                                ...
                                <>
                                  <LibraryComponents.Atoms.Form.InputWrapper>
                                    <select
                                        ...
                                        props.onUpdateItem && props.onUpdateItem(infoRelatedTo,column.dataField,row._id)
                                        }}
                                    >
                                ...
                                <>
                                  <LibraryComponents.Atoms.Form.InputWrapper >
                                        <select
                                            ...
                                            props.onUpdateItem && props.onUpdateItem(infoType,column.dataField,row._id)
                                            }}
                                        >
                                            <option selected>Select</option>
                                            {lookupItems(
                                ...
                                <>
                                  <LibraryComponents.Atoms.Form.InputFile
                                        onChange={(e) => {
                                            ...
                                            props.onUpdateItem && props.onUpdateItem(attachment,column.dataField,row._id)
                                        }}
                                        />
                                </>
                              ),
