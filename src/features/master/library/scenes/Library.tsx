            ...
            <Grid cols={3}>
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    ...
                    >
                      ...
                      >
                        <option selected>Select</option>
                        {lookupItems(routerStore.lookupItems, "LIBRARY_TYPE").map(
                          (item: any, index: number) => (
                            <option key={index} value={item.code}>
                              {lookupValue(item)}
                            </option>
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    ...
                    >
                      ...
                      >
                        <option selected>Select</option>
                        {lookupItems(routerStore.lookupItems, "COMMENT_TYPE").map(
                          (item: any, index: number) => (
                            <option key={index} value={item.code}>
                              {lookupValue(item)}
                            </option>
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    ...
                    >
                      ...
                      >
                        <option selected>Select</option>
                        {lookupItems(routerStore.lookupItems, "COMMENTS_TARGET").map(
                          (item: any, index: number) => (
                            <option key={index} value={item.code}>
                              {lookupValue(item)}
                            </option>
              ...
              <List direction="col" space={4} justify="stretch" fill>
                <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
                    <Form.InputWrapper label="Parameter" hasError={errors.parameter}>
                      <select
                ...
                <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
                    <Form.InputWrapper label="Action" hasError={errors.action}>
                      <select
                ...
                <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
                    <Form.InputWrapper label="Results" hasError={errors.results}>
                      <select
                ...
                <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
                    <Form.InputWrapper label="Reflex" hasError={errors.reflex}>
                      <AutoCompleteCheckMultiFilterKeys
