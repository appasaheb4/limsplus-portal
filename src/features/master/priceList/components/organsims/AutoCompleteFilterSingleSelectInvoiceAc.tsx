...
interface AutoCompleteFilterSingleSelectInnvoiceAcProps {
  onSelect: (item: any) => void
}

export const AutoCompleteFilterSingleSelectInvoiceAc = observer(
  ({ onSelect }: AutoCompleteFilterSingleSelectInnvoiceAcProps) => {
