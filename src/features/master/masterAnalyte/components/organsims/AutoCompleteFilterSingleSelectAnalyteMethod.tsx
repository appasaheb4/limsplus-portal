...
interface AutoCompleteFilterSingleSelectAnalyteMethodProps {
  onSelect: (item: any) => void;
}

export const AutoCompleteFilterSingleSelectAnalayteMethod = observer(
  ({onSelect}: AutoCompleteFilterSingleSelectAnalyteMethodProps) => {
