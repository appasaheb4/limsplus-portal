            ...
            <Grid cols={3}>
              <List direction="col" space={4} justify="stretch" fill>
                ...
                <Controller
                  control={control}
                  render={({ field: { onChange } }) => (
                    <Form.InputWrapper label="AC Class" hasError={errors.acClass}>
                      <select
                        value={
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    ...
                    >
                      ...
                      >
                        <option selected>Select</option>
                        {lookupItems(routerStore.lookupItems, "CUSTOMER_GROUP").map(
                          (item: any, index: number) => (
                            <option key={index} value={item.code}>
                              {lookupValue(item)}
                            </option>
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    ...
                    >
                      ...
                      >
                        <option selected>Select</option>
                        {lookupItems(routerStore.lookupItems, "METHOD_COLN").map(
                          (item: any, index: number) => (
                            <option key={index} value={item.code}>
                              {lookupValue(item)}
                            </option>
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <Form.MultilineInput
                      ...
                      value={
                        registrationLocationsStore.registrationLocations?.address
                      }
                      onChange={(address) => {
                        onChange(address)
                        registrationLocationsStore.updateRegistrationLocations({
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <Form.Input
                      ...
                      value={
                        registrationLocationsStore.registrationLocations?.fyiLine
                      }
                      onChange={(fyiLine) => {
                        onChange(fyiLine)
                        registrationLocationsStore.updateRegistrationLocations({
