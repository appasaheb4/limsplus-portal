      ...
      reader.addEventListener('load', (evt: any) => {
        ...
        const list = data.map((item: any) => {
          return {
            ...
            autoFinish: item['Auto Finish'],
            holdOOS: item['Hold OOS'],
            ...
            cretical: item.Cretical,
            repitation: item.Repitation,
            printLabel: item['Print Label'],
            cumulative: item.Cumulative,
            labelInstruction: item['Label Instruction'],
            qcHold: item['QC Hold'],
            deltaHold: item['Delta Hold'],
            prefix: item.Prefix,
            sufix: item.Sufix,
            speicalInstructions: item['Speical Instructions'],
            allowPartial: item['Allow Partial'],
